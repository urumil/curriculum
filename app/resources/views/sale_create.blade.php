...
<div class="card-body">
    <form action="{{ route('create') }}" method="post" enctype="multipart/form-data"> 
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="name" class="form-control" name="name" placeholder="例：イヤリング" value="{{ old('name') }}">
          </div>
        </div>
        <div class="form-group row">
          <label for="price" class="col-sm-2 col-form-label">価格</label>
          <div class="col-sm-10">
            <input type="price" class="form-control" name="price" placeholder="円" value="{{ old('price') }}">
          </div>
        </div>
        <div class="form-group row">
          <label for="quality" class="col-sm-2 col-form-label">商品状態</label>
          <div class="col-sm-10">
            <select class="custom-select mr-sm-2" name="quality" value="{{ old('quality') }}">
        ...
        <label for="comment" class="col-sm-2 col-form-label">商品の説明</label>
          <div class="col-sm-10">
            <textarea class="form-control" name="comment" rows="3" placeholder="例：2023年秋ごろ購入し使用済み。" value="{{ old('comment') }}"></textarea>
          </div>
        </div>
