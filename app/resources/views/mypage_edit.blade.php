...
@section('content')
<div class="card-body">
    <form action="{{ route('edit', $result['id']) }}" method="post">
      @csrf
      <div class="mb-3">
        <img src="{{ asset('storage/images' . $result['image']) }}" id="img" class="rounded mx-auto d-block" width="210" height="210" alt="...">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="profile" value="{{ $result['profile'] }}"></textarea>
      </div>
